...
interface timelineConfigProp {
  ...
  intervalVariant?: "adjust" | "even" | "odd";
}
  ...
  useEffect(() => {
    ...
    const xAxis = (g: any, x: any) => {
      ...
      g.selectAll(".tick").each(function (this: any, d: any, i: number) {
        ...
        const shouldShow = (() => {
          ...
          //         return i % 2 !== 0;
          //       case "adjust":
          //         return tickGapRef.current < 50 ? i % 2 === 0 : true;
          //       default:
          //         return true;
          //     }
          //   }
          ...
          switch (timelineConfig.intervalVariant) {
            ...
            case "odd":
              return i % 2 !== 0;
            case "adjust":
              return tickGapRef.current < 80 ? i % 2 === 0 : true;
            default:
              return true;
          }
        })();
    ...
    const zoom = d3
      ...
      .on("end", (event: any) => {
        ...
        onScrollorZoomEnd(range, currentInterval.key);
      });
    // .on("zoom end", (event: any) => {
    //   const xz = event.transform.rescaleX(x);
